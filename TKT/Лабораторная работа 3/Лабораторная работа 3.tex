...
\begin{minted}[linenos]{matlab}
    ...
    disp('==============================');
    disp('Вывод:');
    disp(['XOR-контроль четности обнаруживает ', ...
        'ошибки только при нечетном количестве ', ...
        'искаженных бит.']);
    disp(['При четном количестве ошибок ', ...
