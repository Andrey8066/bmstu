...
\begin{center}
  \includegraphics[width=0.6\textwidth]{logic1.png}
\end{center}

Для функции 2

\begin{center}
  \includegraphics[width=0.6\textwidth]{logic2.png}
\end{center}
...
\begin{center}
  \includegraphics[width=0.6\textwidth]{logicnotandunit.png}
\end{center}

При моделирование этой схемы получаем следующую модель ДКЦУ

\begin{center}
  \includegraphics[width=0.6\textwidth]{schemetest.png}
\end{center}
